...
Story: Logging in
  As an anonymous admin_user with an account
  ...
  # Log in: get form
  #
  Scenario: Anonymous admin_user can get a login form.
  ...
  #
  Scenario: Anonymous admin_user can log in
    Given an anonymous admin_user
  ...
  Scenario: Logged-in admin_user who logs in should be the new one
    Given an activated admin_user named 'reggie'
     And  an activated admin_user logged in as 'oona'
    When  she creates a singular sessions with login: 'reggie', password: 'monkey', remember me: ''
    Then  she should be redirected to the home page
    When  she follows that redirect!
    Then  she should see a notice message 'Logged in successfully'
  ...
  #
  Scenario: Anonymous admin_user can log in and be remembered
    Given an anonymous admin_user
     And  an activated admin_user named 'reggie'
    ...
    Then  she should see a notice message 'Logged in successfully'
     ...
     And  her session store should have admin_user_id: 4
   
  #
  # Log in unsuccessfully
  #
  
  Scenario: Logged-in admin_user who fails logs in should be logged out
    Given an activated admin_user named 'oona'
    ...
    Then  she should see an error message 'Couldn't log you in as 'reggie''
     ...
     And  she should not have an auth_token cookie
     And  her session store should not have admin_user_id
  ...
  #
  Scenario: Anonymous (logged out) admin_user can log out.
    Given an anonymous admin_user
  ...
  Scenario: Logged in admin_user can log out.
    Given an activated admin_user logged in as 'reggie'
    When  she goes to /logout
    Then  she should be redirected to the home page
    When  she follows that redirect!
    Then  she should see a notice message 'You have been logged out'
