...
Story: Creating an account
  ...
  #
  Scenario: Anonymous admin_user can start creating an account
    Given an anonymous admin_user
    When  she goes to /signup
    Then  she should be at the 'admin_users/new' page
  ...
  # Account Creation
  #
  Scenario: Anonymous admin_user can create an account
    Given an anonymous admin_user
     And  no admin_user with login: 'Oona' exists
    ...
    Then  she should see a notice message 'Thanks for signing up!'
     And  a admin_user with login: 'oona' should exist
     And  the admin_user should have login: 'oona', and email: 'unactivated@example.com'
  ...
  Scenario: Anonymous admin_user can not create an account replacing an activated account
    Given an anonymous admin_user
     And  an activated admin_user named 'Reggie'
     And  we try hard to remember the admin_user's updated_at, and created_at
    ...
    Then  she should be at the 'admin_users/new' page
     ...
     And  a admin_user with login: 'reggie' should exist
     And  the admin_user should have email: 'registered@example.com'

     And  the admin_user's created_at should stay the same under to_s
     And  the admin_user's updated_at should stay the same under to_s
     And  she should not be logged in

  #
  # Account Creation Failure: Incomplete input
  #
  Scenario: Anonymous admin_user can not create an account with incomplete or incorrect input
    Given an anonymous admin_user
     And  no admin_user with login: 'Oona' exists
    ...
    Then  she should be at the 'admin_users/new' page
     ...
     And  no admin_user with login: 'oona' should exist
     
  Scenario: Anonymous admin_user can not create an account with no password
    Given an anonymous admin_user
     And  no admin_user with login: 'Oona' exists
  ...
  Scenario: Anonymous admin_user can not create an account with no password_confirmation
    Given an anonymous admin_user
     And  no admin_user with login: 'Oona' exists
  ...
  Scenario: Anonymous admin_user can not create an account with mismatched password & password_confirmation
    Given an anonymous admin_user
     And  no admin_user with login: 'Oona' exists
  ...
  Scenario: Anonymous admin_user can not create an account with bad email
    Given an anonymous admin_user
     And  no admin_user with login: 'Oona' exists
