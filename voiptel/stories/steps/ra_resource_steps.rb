...
steps_for(:ra_resource) do
  ...
  #   "Given a admin_user with login: 'mojojojo'" 
  # produces a AdminUser instance stored in @admin_user with 'mojojojo' as its login
  # attribute.
  #
  ...
  #   "And the admin_user has thac0: 3"
  # takes the earlier-defined @admin_user instance and sets its thac0 to '3'.
  #
...
#
# So, for instance,
#   klass, instance = parse_resource_args 'admin_user'
#   instance = klass.new({login => 'me', password => 'monkey', ...})
#   keep_instance! resource, instance
# keeps the just-constructed AdminUser model in the @admin_user instance variable.
#
