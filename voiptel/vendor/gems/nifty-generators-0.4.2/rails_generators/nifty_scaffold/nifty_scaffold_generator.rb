    ...
    record do |m|
      ...
      unless options[:skip_controller]
        ...
        controller_actions.each do |action|
          ...
          if File.exist? source_path("views/#{view_language}/#{action}.rjs")
            m.template "views/#{view_language}/#{action}.rjs", "app/views/#{plural_name}/#{action}.rjs"
          end
        end
