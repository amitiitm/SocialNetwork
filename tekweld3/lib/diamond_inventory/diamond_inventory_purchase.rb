module DiamondInventory::DiamondInventoryPurchase
  ...
  class Posting
    ...
    def create_inventory_postings(object)
      ...
      curr_lines.each{|curr_line|
        ...
        customer_vendor_flag = 'V'
        customer_vendor_id = object.vendor_id
    ...
    def identify_memo_ri_flags(object)
      ...
      when 'DiamondPurchase::DiamondPurchaseInvoice'
        ...
        memo?(object.ref_type)? ri_flag = INVN_TRANSFER : ri_flag = INVN_RECEIVE
      when 'DiamondPurchase::DiamondPurchaseMemo'
    ...
    def identify_post_lines(object)
      object_lines = object.diamond_purchase_lines
      return object_lines
    end
