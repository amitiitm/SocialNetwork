module DiamondPurchase::DiamondPurchaseGlPosting
  #  include General
  ...
  class Posting
    ...
    def create_gl_postings(object)
      ar_account_id, shipping_account_id, discount_account_id, salestax_account_id, default_account_id = fetch_gl_account_for_purchase()
      gl_postings = []
      dtl_serial_no = PURCHASE_INVOICE_GL_SERIAL_NO
    ...
    def fetch_gl_account_for_purchase()
    ...
    def identify_purchase_post_lines(object)
      ...
      #      else
      #      end
      current_lines =  object.diamond_purchase_lines.to_ary.find_all { |line| line.trans_flag == 'A' and nulltozero(line.net_amt) != 0 }  
      current_lines
    end

    private :fetch_gl_account_for_purchase, :post_net_amt, :post_salestax_amt,:post_discount_amt, :post_shipping_amt, :post_other_amt, 
