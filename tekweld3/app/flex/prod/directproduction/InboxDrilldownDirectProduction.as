package prod.directproduction
{
	...
	public class InboxDrilldownDirectProduction implements IDrillDown
	{
		...
		private function handleVariableRowDrillDown():void
		{
			...
			var __localModel:DirectProductionModelLocator  	= DirectProductionModelLocator(__genModel.activeModelLocator);
