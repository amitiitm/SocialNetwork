...
import prod.filmjob.FilmJobController;
import prod.filmjob.FilmJobModelLocator;
import prod.filmjob.FilmJobServices;
import prod.filmjob.components.FilmJobAddEdit;
...
[Bindable]
protected var __localModel:FilmJobModelLocator = new FilmJobModelLocator();

public function handleFilmJobAcitve(event:GenModuleEvent):void
{
	__genModel.controller 			= new FilmJobController();
	__genModel.services 			= new FilmJobServices();
...
public function handleCreationComplete(event:FlexEvent):void
{
	...
	__localModel.addEditObj.addEditContainer = new FilmJobAddEdit();
