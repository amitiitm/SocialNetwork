package prod.paidprint
{
	...
	public class InboxDrilldownPaidPrint implements IDrillDown
	{
		...
		private function handleVariableRowDrillDown():void
		{
			...
			var __localModel:PaidPrintModelLocator  = PaidPrintModelLocator(__genModel.activeModelLocator);
