package prod.embroiderydigitization
{
	...
	public class InboxDrilldownEmbroideryDigitization implements IDrillDown
	{
		...
		private function handleVariableRowDrillDown():void
		{
			...
			var __localModel:EmbroideryDigitizationModelLocator  = EmbroideryDigitizationModelLocator(__genModel.activeModelLocator);
