package prod.pickjob
{
	...
	public class InboxDrilldownPickJob implements IDrillDown
	{
		...
		private function handleVariableRowDrillDown():void
		{
			...
			var __localModel:PickJobModelLocator	= PickJobModelLocator(__genModel.activeModelLocator);
			var tabpage:TabPage						=	new TabPage();
