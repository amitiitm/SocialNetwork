...
import prod.receivedigitizedjob.ReceiveDigitizedJobController;
import prod.receivedigitizedjob.ReceiveDigitizedJobModelLocator;
import prod.receivedigitizedjob.ReceiveDigitizedJobServices;
import prod.receivedigitizedjob.components.ReceiveDigitizedJobAddEdit;
...
[Bindable]
protected var __localModel:ReceiveDigitizedJobModelLocator = new ReceiveDigitizedJobModelLocator();

public function handleReceiveDigitizedJobAcitve(event:GenModuleEvent):void
{
	__genModel.controller 			= new ReceiveDigitizedJobController();
	__genModel.services 			= new ReceiveDigitizedJobServices();
...
public function handleCreationComplete(event:FlexEvent):void
{
	...
	__localModel.addEditObj.addEditContainer = new ReceiveDigitizedJobAddEdit();
