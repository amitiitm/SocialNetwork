package prod.packagejob
{
	...
	public class InboxDrilldownPackageJob implements IDrillDown
	{
		...
		private function handleVariableRowDrillDown():void
		{
			...
			var __localModel:PackageJobModelLocator	= PackageJobModelLocator(__genModel.activeModelLocator);
			var tabpage:TabPage						=	new TabPage();
