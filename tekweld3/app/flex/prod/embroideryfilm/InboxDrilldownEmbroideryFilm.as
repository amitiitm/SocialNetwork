package prod.embroideryfilm
{
	...
	public class InboxDrilldownEmbroideryFilm implements IDrillDown
	{
		...
		private function handleVariableRowDrillDown():void
		{
			...
			var __localModel:EmbroideryFilmModelLocator  = EmbroideryFilmModelLocator(__genModel.activeModelLocator);
