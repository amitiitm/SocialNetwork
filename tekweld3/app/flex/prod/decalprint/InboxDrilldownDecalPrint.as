package prod.decalprint
{
	...
	public class InboxDrilldownDecalPrint implements IDrillDown
	{
		...
		private function handleVariableRowDrillDown():void
		{
			...
			var __localModel:DecalPrintModelLocator  = DecalPrintModelLocator(__genModel.activeModelLocator);
