package prod.decalimposition
{
	...
	public class InboxDrilldownDecalImposition implements IDrillDown
	{
		...
		private function handleVariableRowDrillDown():void
		{
			...
			var __localModel:DecalImpositionModelLocator  = DecalImpositionModelLocator(__genModel.activeModelLocator);
			
			if(__genModel.drillObj.drillrow.trans_type.toString()=='S' ||  __genModel.drillObj.drillrow.trans_type.toString()=='F')
			{
				var tabpage:TabPage	=	new TabPage();
