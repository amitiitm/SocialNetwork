package prod.vendorinbox
{
	...
	public class InboxDrilldownVendorInbox implements IDrillDown
	{
		...
		private function handleVariableRowDrillDown():void
		{
			...
			var __localModel:VendorInboxModelLocator	= VendorInboxModelLocator(__genModel.activeModelLocator);
			var tabpage:TabPage						=	new TabPage();
