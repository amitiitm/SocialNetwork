package prod.gumimposition
{
	...
	public class InboxDrilldownGumImposition implements IDrillDown
	{
		...
		private function handleVariableRowDrillDown():void
		{
			...
			var __localModel:GumImpositionModelLocator  = GumImpositionModelLocator(__genModel.activeModelLocator);
