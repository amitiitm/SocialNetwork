package prod.shiptovendor
{
	...
	public class InboxDrilldownShipToVendor implements IDrillDown
	{
		...
		private function handleVariableRowDrillDown():void
		{
			...
			var __localModel:ShipToVendorModelLocator  = ShipToVendorModelLocator(__genModel.activeModelLocator);
