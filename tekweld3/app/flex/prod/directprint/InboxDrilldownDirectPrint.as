package prod.directprint
{
	...
	public class InboxDrilldownDirectPrint implements IDrillDown
	{
		...
		private function handleVariableRowDrillDown():void
		{
			...
			var __localModel:DirectPrintModelLocator  	= DirectPrintModelLocator(__genModel.activeModelLocator);
