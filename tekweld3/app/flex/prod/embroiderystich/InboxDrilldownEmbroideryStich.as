package prod.embroiderystich
{
	...
	public class InboxDrilldownEmbroideryStich implements IDrillDown
	{
		...
		private function handleVariableRowDrillDown():void
		{
			...
			var __localModel:EmbroideryStichModelLocator  = EmbroideryStichModelLocator(__genModel.activeModelLocator);
