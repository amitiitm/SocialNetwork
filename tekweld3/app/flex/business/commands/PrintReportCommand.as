package business.commands
{
	...
	public class PrintReportCommand implements ICommand
	{
		...
		public function execute(event:CairngormEvent):void
		{
			...
			else
			{
				...
				Alert.show('cannot print more than two groups.')
				return;
			}
			...
			var callbacksPrintReport:Responder = new Responder(printReportCommandResultHandler, faultHandler);
		...
		private function printReportCommandResultHandler(event:ResultEvent):void
		{
			CursorManager.removeBusyCursor();
			Application.application.enabled = true;
