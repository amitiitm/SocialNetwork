package business.commands
{
	...
	public class PrintGridCommand implements ICommand
	{
		...
		{
			genDataGrid= (event as PrintGridEvent).genDataGrid;
			reportName= (event as PrintGridEvent).reportName;
			viewName= (event as PrintGridEvent).viewName;
