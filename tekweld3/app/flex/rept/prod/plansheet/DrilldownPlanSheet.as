package rept.prod.plansheet
{
	...
	public class DrilldownPlanSheet implements IDrillDown
	{
		...
		{
			var __local:PlanSheetModelLocator = new PlanSheetModelLocator();
			__local = PlanSheetModelLocator(GenModelLocator.getInstance().activeModelLocator);
