package rept.prod.productiontracking
{
	...
	public class DrilldownProductionTracking implements IDrillDown
	{
		...
		{
			var __local:ProductionTrackingModelLocator = new ProductionTrackingModelLocator();
			__local = ProductionTrackingModelLocator(GenModelLocator.getInstance().activeModelLocator);
