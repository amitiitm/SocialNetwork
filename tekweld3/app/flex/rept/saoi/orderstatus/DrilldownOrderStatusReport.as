package rept.saoi.orderstatus
{
	...
	public class DrilldownOrderStatusReport implements IDrillDown
	{
		...
		{
			var __local:OrderStatusModelLocator = new OrderStatusModelLocator();
			__local = OrderStatusModelLocator(GenModelLocator.getInstance().activeModelLocator);
