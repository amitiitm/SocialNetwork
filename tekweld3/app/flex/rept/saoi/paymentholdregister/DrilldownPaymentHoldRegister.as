package rept.saoi.paymentholdregister
{
	...
	public class DrilldownPaymentHoldRegister implements IDrillDown
	{
		...
		{
			var __local:PaymentHoldRegisterModelLocator = new PaymentHoldRegisterModelLocator();
			__local = PaymentHoldRegisterModelLocator(GenModelLocator.getInstance().activeModelLocator);
