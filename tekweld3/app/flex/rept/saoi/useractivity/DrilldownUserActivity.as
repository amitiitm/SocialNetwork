package rept.saoi.useractivity
{
	...
	public class DrilldownUserActivity implements IDrillDown
	{
		...
		{
			var __local:UserActivityModelLocator = new UserActivityModelLocator();
			__local = UserActivityModelLocator(GenModelLocator.getInstance().activeModelLocator);
