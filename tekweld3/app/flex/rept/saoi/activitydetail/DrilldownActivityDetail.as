package rept.saoi.activitydetail
{
	...
	public class DrilldownActivityDetail implements IDrillDown
	{
		...
		{
			var __local:ActivityDetailModelLocator = new ActivityDetailModelLocator();
			__local = ActivityDetailModelLocator(GenModelLocator.getInstance().activeModelLocator);
