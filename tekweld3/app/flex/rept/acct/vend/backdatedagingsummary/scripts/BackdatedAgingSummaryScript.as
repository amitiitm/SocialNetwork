...
import rept.acct.vend.backdatedagingsummary.BackdatedAgingSummaryController;
import rept.acct.vend.backdatedagingsummary.BackdatedAgingSummaryModelLocator;
import rept.acct.vend.backdatedagingsummary.BackdatedAgingSummaryServices;

[Bindable]
protected var __genModel:GenModelLocator = GenModelLocator.getInstance();

[Bindable]
protected var __localModel:BackdatedAgingSummaryModelLocator = new BackdatedAgingSummaryModelLocator();

public function handleBackdatedAgingSummaryActive(event:GenModuleEvent):void
{
	__genModel.controller			= new BackdatedAgingSummaryController();
	__genModel.services 			= new BackdatedAgingSummaryServices();
...
{
	var bracket1_header_from :String 	= __genModel.masterData.child('aging_vendor').bracket_1_from.value.toString()
	var bracket1_header_to :String 		= __genModel.masterData.child('aging_vendor').bracket_1_to.value.toString()
			
	var bracket2_header_from :String 	= __genModel.masterData.child('aging_vendor').bracket_2_from.value.toString()
	var bracket2_header_to :String 		= __genModel.masterData.child('aging_vendor').bracket_2_to.value.toString()

	var bracket3_header_from :String 	= __genModel.masterData.child('aging_vendor').bracket_3_from.value.toString()
	var bracket3_header_to :String 		= __genModel.masterData.child('aging_vendor').bracket_3_to.value.toString()

	var bracket4_header_from :String 	= __genModel.masterData.child('aging_vendor').bracket_4_from.value.toString()
	var bracket4_header_to :String 		= __genModel.masterData.child('aging_vendor').bracket_4_to.value.toString()
	
	var bracket5_header_from :String 	= __genModel.masterData.child('aging_vendor').bracket_5_from.value.toString()
	var bracket5_header_to :String 		= __genModel.masterData.child('aging_vendor').bracket_5_to.value.toString()

	var bracket6_header_from :String 	= __genModel.masterData.child('aging_vendor').bracket_6_from.value.toString()
	var bracket6_header_to :String 		= __genModel.masterData.child('aging_vendor').bracket_6_to.value.toString()

	var bracket7_header_from :String 	= __genModel.masterData.child('aging_vendor').bracket_7_from.value.toString()
