package ship.directshipping
{
	...
	public class InboxDrilldownDirectShipping implements IDrillDown
	{
		...
		private function handleVariableRowDrillDown():void
		{
			...
			var __localModel:DirectShippingModelLocator  	= DirectShippingModelLocator(__genModel.activeModelLocator);
