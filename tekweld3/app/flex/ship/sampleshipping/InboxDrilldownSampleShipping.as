package ship.sampleshipping
{
	...
	public class InboxDrilldownSampleShipping implements IDrillDown
	{
		...
		private function handleVariableRowDrillDown():void
		{
			...
			var __localModel:SampleShippingModelLocator  	= SampleShippingModelLocator(__genModel.activeModelLocator);
