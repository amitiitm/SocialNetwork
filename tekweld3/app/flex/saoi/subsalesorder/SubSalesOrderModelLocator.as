package saoi.subsalesorder
{
	...
	[Bindable]
	public class SubSalesOrderModelLocator
	{
		...
		public var do_not_chnage_ship_date:String;
		...
		public var setupXml:XML 									= 	new XML();    // for default setup  and rush\
		public var next_day_flag:Boolean;
		public var notes_emails:Array								= new Array();
		...
		public var isDiscountCouponBaseChange:Boolean  				= false;
		
		public var thirdPartyShippingCharge:XML						= new XML();
		public var defaultSetupCharge:XML							= new XML();
		
		public var discount_item_xml:XML  							= new XML(<discount_coupons></discount_coupons>);
