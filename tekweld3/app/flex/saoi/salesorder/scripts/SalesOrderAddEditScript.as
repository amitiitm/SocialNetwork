...
override protected function retrieveRecordEventHandler(event:AddEditEvent):void  //after save and prev,next,.....
{
	...
	/*var recommendation:String  = recordXml.sales_order.recommendation.toString();
...
/*
private function setEstimatedDateByIncrement(screenComponents:UIComponent,chnageEvent:Event,ext_ref_date:Object,next_day_flag:Object,paper_proof_flag:Object,rushdays:Object,dtlShipping:Object):void
{
	
	commonMooduleFunctions.shipmentImpactMsg(screenComponents,chnageEvent,ext_ref_date,next_day_flag,paper_proof_flag,rushdays,dtlShipping);
...
private function setReAssignFlagVisiblity(xml:XML):void
{
	...
	/*else if(orderentrycomplete_flag=='Y')
	{
		cbReassignedToOrderEntry.visible         = true;
		cbReassignedToOrderEntry.includeInLayout = true;
	}
