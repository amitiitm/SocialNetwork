package saoi.invalidcustomeremailorder
{
	...
	public class InboxDrilldownInvalidCustomerEmail implements IDrillDown
	{
		...
		private function handleVariableRowDrillDown():void
		{
			...
			var __localModel:InvalidCustomerEmailModelLocator  = InvalidCustomerEmailModelLocator(__genModel.activeModelLocator);
