...
import saoi.assignedorder.components.AssignedOrder;

[Bindable]
private var __genModel:GenModelLocator = GenModelLocator.getInstance();
[Bindable]
private var __localModel:AssignedOrderModelLocator  =  AssignedOrderModelLocator(__genModel.activeModelLocator);
...
private function init():void
{
	...
	AssignedOrder(this.parentDocument).bcp.addChild(refreshLabel);
...
{
	Label(AssignedOrder(this.parentDocument).bcp.getChildByName("refreshLabel")).text =	"this screen will automatically refresh within "+remainingTime.toString()+" sec."; ;
...
{
	Alert.show("AssignedOrder"+event.fault.faultDetail.toString());
