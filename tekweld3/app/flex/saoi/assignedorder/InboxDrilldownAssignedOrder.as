package saoi.assignedorder
{
	...
	public class InboxDrilldownAssignedOrder implements IDrillDown
	{
		...
		private function handleVariableRowDrillDown():void
		{
			...
			var __localModel:AssignedOrderModelLocator  = AssignedOrderModelLocator(__genModel.activeModelLocator);
