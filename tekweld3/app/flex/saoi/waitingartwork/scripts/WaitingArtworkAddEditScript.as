...
import saoi.waitingartwork.components.WaitingArtwork;

[Bindable]
private var __genModel:GenModelLocator = GenModelLocator.getInstance();
[Bindable]
private var __localModel:WaitingArtworkModelLocator  =  WaitingArtworkModelLocator(__genModel.activeModelLocator);
...
private function init():void
{
	...
	WaitingArtwork(this.parentDocument).bcp.addChild(refreshLabel);
...
{
	Label(WaitingArtwork(this.parentDocument).bcp.getChildByName("refreshLabel")).text =	"this screen will automatically refresh within "+remainingTime.toString()+" sec."; ;
...
{
	Alert.show("WaitingArtwork"+event.fault.faultDetail.toString());
