package saoi.waitingartwork
{
	...
	public class InboxDrilldownWaitingArtwork implements IDrillDown
	{
		...
		private function handleVariableRowDrillDown():void
		{
			...
			var __localModel:WaitingArtworkModelLocator  = WaitingArtworkModelLocator(__genModel.activeModelLocator);
