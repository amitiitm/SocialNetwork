...
private function setRequestedInhandDate():void
{
	if(!__genModel.activeModelLocator.addEditObj.isRecordViewOnly)
	{
		...
		else
		{
			...
			commonFunctions.setInhandDate(this,dcShipping_code,tiShip_zip,tiShip_country,tiAmount,tiShipMethod,dfArrivalShip_date,dfEstimaedShip_date,dfShip_date,dfInhand_date,'',tiQty,__localModel.trans_no,tiShip_state,lblShipAmountFormula,lblApiCalling,cbBillingTransportationTo,tiShipMethodCode);
		}
	}
}
