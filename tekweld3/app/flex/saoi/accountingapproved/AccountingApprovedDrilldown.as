package saoi.accountingapproved
{
	...
	public class AccountingApprovedDrilldown implements IDrillDown
	{
		...
		private function handleVariableRowDrillDown():void
		{
			...
			var __localModel:AccountingApprovedModelLocator  = AccountingApprovedModelLocator(__genModel.activeModelLocator);
			var tabpage:TabPage	=	new TabPage();
