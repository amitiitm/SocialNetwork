package saoi.sendforestimation
{
	...
	public class InboxDrilldownSendForEstimation implements IDrillDown
	{
		...
		private function handleVariableRowDrillDown():void
		{
			...
			var __localModel:SendForEstimationModelLocator  = SendForEstimationModelLocator(__genModel.activeModelLocator);
