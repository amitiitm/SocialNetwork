package saoi.customerstitchapproval
{
	...
	public class InboxDrilldownCustomerStitchApproval implements IDrillDown
	{
		...
		private function handleVariableRowDrillDown():void
		{
			...
			var __localModel:CustomerStitchApprovalModelLocator  = CustomerStitchApprovalModelLocator(__genModel.activeModelLocator);
