package saoi.cancelorder
{
	...
	public class InboxDrilldownCancelOrder implements IDrillDown
	{
		...
		private function handleVariableRowDrillDown():void
		{
			...
			var __localModel:CancelOrderModelLocator  = CancelOrderModelLocator(__genModel.activeModelLocator);
