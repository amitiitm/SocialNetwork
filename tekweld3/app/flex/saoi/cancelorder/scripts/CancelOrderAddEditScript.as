...
import saoi.cancelorder.components.CancelOrder;
import saoi.qcorder.QcOrderModelLocator;
import saoi.qcorder.components.QcOrder;

[Bindable]
private var __genModel:GenModelLocator = GenModelLocator.getInstance();
[Bindable]
private var __localModel:CancelOrderModelLocator  =  CancelOrderModelLocator(__genModel.activeModelLocator);
...
private function init():void
{
	...
	CancelOrder(this.parentDocument).bcp.addChild(refreshLabel);
...
{
	Label(CancelOrder(this.parentDocument).bcp.getChildByName("refreshLabel")).text =	"this screen will automatically refresh within "+remainingTime.toString()+" sec."; ;
...
{
	Alert.show("CacelOrder"+event.fault.faultDetail.toString());
