...
[Bindable]
private var isFinalVersionVisible:Boolean			= false;
...
private function setIsFinalVersionVisible():void
{
	if(__localModel.paper_proof_flag.toUpperCase()!='Y')
	{
		isFinalVersionVisible	= true;
	}
	else
	{
		isFinalVersionVisible	= false;
	}
