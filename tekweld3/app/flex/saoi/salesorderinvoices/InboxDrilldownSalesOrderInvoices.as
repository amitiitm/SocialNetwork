package saoi.salesorderinvoices
{
	...
	public class InboxDrilldownSalesOrderInvoices implements IDrillDown
	{
		...
		private function handleVariableRowDrillDown():void
		{
			...
			var __localModel:SalesOrderInvoicesModelLocator  = SalesOrderInvoicesModelLocator(__genModel.activeModelLocator);
