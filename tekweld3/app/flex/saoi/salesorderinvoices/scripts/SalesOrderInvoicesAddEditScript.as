...
import saoi.salesorderinvoices.components.SalesOrderInvoices;


[Bindable]
private var __genModel:GenModelLocator = GenModelLocator.getInstance();
[Bindable]
private var __localModel:SalesOrderInvoicesModelLocator  =  SalesOrderInvoicesModelLocator(__genModel.activeModelLocator);
...
private function init():void
{
	...
	SalesOrderInvoices(this.parentDocument).bcp.addChild(refreshLabel);
...
{
	Label(SalesOrderInvoices(this.parentDocument).bcp.getChildByName("refreshLabel")).text =	"this screen will automatically refresh within "+remainingTime.toString()+" sec."; ;
...
{
	Alert.show("QcOrder"+event.fault.faultDetail.toString());
