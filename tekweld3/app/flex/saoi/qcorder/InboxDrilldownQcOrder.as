package saoi.qcorder
{
	...
	public class InboxDrilldownQcOrder implements IDrillDown
	{
		...
		private function handleVariableRowDrillDown():void
		{
			...
			var __localModel:QcOrderModelLocator  = QcOrderModelLocator(__genModel.activeModelLocator);
