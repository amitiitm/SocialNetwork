...
[Bindable]
private var __localModel:QcOrderModelLocator  =  QcOrderModelLocator(__genModel.activeModelLocator);
...
private function init():void
{
	...
	QcOrder(this.parentDocument).bcp.addChild(refreshLabel);
...
{
	Label(QcOrder(this.parentDocument).bcp.getChildByName("refreshLabel")).text =	"this screen will automatically refresh within "+remainingTime.toString()+" sec."; ;
