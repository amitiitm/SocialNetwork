package saoi.makecancelorder
{
	...
	public class InboxDrilldownMakeCancelOrder implements IDrillDown
	{
		...
		private function handleVariableRowDrillDown():void
		{
			...
			var __localModel:MakeCancelOrderModelLocator  = MakeCancelOrderModelLocator(__genModel.activeModelLocator);
