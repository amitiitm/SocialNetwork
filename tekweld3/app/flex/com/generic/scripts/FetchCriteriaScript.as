...
public function initializeView(viewFormat:XML , viewDataXML:XML):void
{
...
private function btnQueryClickHandler(event:MouseEvent):void
{
	if (lbSuccess)
	{
		...
		this.dispatchEvent(new FetchCriteriaEvent(FetchCriteriaEvent.OK_CLICK_EVENT,selectedView))
		closePopUp();
	}
	else
	{
...
private function populateListResultHandler(event:ResultEvent):void
{
	...
	targetObj.rows = new XML((XML)(event.result));
}
