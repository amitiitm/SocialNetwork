...
[Bindable]
protected var __localModel:ShippingModelLocator = new ShippingModelLocator();

public function handleShippingAcitve(event:GenModuleEvent):void
{
	__genModel.controller = new ShippingController();
	__genModel.services = new ShippingServices();
...
public function handleCreationComplete(event:FlexEvent):void
{
	...
	__localModel.addEditObj.addEditContainer = new ShippingAddEdit();
    __localModel.listObj.listGrid = listControlComponent.dgList;
    
    __localModel.importObj.container = new ShippingImport()
