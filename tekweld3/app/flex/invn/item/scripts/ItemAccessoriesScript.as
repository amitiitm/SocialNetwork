...
private function handleItemChange():void
{
	if(dcItemId.text != null && dcItemId.text != '')
	{
		var callbacks:IResponder = new mx.rpc.Responder(getItemDetailsHandler, null);
		
		var getInformationEvent:GetInformationEvent = new GetInformationEvent('iteminfo', callbacks, dcItemId.dataValue, new GenDateField().currentDate());
