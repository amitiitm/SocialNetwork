class Purchase::PurchaseOrderLine < ActiveRecord::Base
  include UserStamp
  include Dbobject
  include General
  include ClassMethods

  belongs_to :purchase_order, :class_name => 'Purchase::PurchaseOrder'
...
#    line.types = 'PurchaseOrder'     if ( line and line.new_record?)
