class CreateDiamondPurchaseLines < ActiveRecord::Migration
  def self.up
    create_table :diamond_purchase_lines do |t|
      ...
      t.integer   :diamond_lot_id, :diamond_packet_id, :diamond_purchase_id
  ...
  def self.down
    drop_table :diamond_purchase_lines
  end
end
