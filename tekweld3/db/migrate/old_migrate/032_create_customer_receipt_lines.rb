class CreateCustomerReceiptLines < ActiveRecord::Migration
  def self.up
    create_table :customer_receipt_lines do |t|
      ...
      t.integer   :customer_receipt_id,  :gl_account_id 
  ...
  def self.down
    drop_table :customer_receipt_lines
  end
end
