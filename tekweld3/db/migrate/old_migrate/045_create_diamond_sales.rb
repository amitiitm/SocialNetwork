class CreateDiamondSales < ActiveRecord::Migration
  def self.up
    create_table :diamond_sales do |t|
      ...
      t.integer   :customer_id, :customer_shipping_id	
      t.string    :account_period_code, :limit=>8
      t.string    :shipping_code, :term_code, :salesperson_code, :limit=>25
