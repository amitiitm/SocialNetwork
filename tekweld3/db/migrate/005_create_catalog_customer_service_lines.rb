class CreateCatalogCustomerServiceLines < ActiveRecord::Migration
  def self.up
    create_table :catalog_customer_service_lines do |t|
  ...
  def self.down
    drop_table :catalog_customer_service_lines
  end
end
